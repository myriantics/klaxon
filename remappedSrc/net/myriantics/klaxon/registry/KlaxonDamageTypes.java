...
public class KlaxonDamageTypes {
    ...
    public static DamageSource hammerBonking(Entity attacker) {
        return new DamageSource(attacker.method_48926().getDamageSources().registry.entryOf(HAMMER_BONKING), attacker);
    }
    public static DamageSource hammerWalloping(Entity attacker) {
        return new DamageSource(attacker.method_48926().getDamageSources().registry.entryOf(HAMMER_WALLOPING), attacker);
    }
