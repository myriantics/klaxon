...
public final class KlaxonEnUsJadeTextProvider extends KlaxonEnUsLanguageSubProvider {
    ...
    private void generateTooltipTextTranslations() {
        addRawText(ExplosiveCatalystVesselProvider.DATA_HIDDEN, "Hidden Or Missing");
        addRawText(ExplosiveCatalystVesselProvider.EXPLOSION_POWER, "Explosion Power: %s");
    ...
    private void generateConfigTextTranslations() {
        ...
        addRawText(ExplosiveCatalystVesselProvider.CONFIG, "Explosive Catalyst Vessels: ");
