...
import net.myriantics.klaxon.registry.item.KlaxonCreativeModeTabs;
...
public final class KlaxonEnUsItemGroupLanguageProvider extends KlaxonEnUsLanguageSubProvider {
    ...
    public void generate() {
        addItemGroup(KlaxonCreativeModeTabs.KLAXON_BUILDING_BLOCKS_ID, "KLAXON's Building Blocks");
        addItemGroup(KlaxonCreativeModeTabs.KLAXON_EQUIPMENT_ID, "KLAXON's Equipment");
        addItemGroup(KlaxonCreativeModeTabs.KLAXON_MACHINES_ID, "KLAXON's Machines");
        addItemGroup(KlaxonCreativeModeTabs.KLAXON_MATERIALS_ID, "KLAXON's Materials");
    }
}
