...
public class MakeshiftShapelessCraftingRecipe extends ShapelessRecipe {
    ...
    public MakeshiftShapelessCraftingRecipe(String group, CraftingRecipeCategory category, ItemStack result, DefaultedList<Ingredient> ingredients, List<Ingredient> potentialMakeshiftIngredients) {
