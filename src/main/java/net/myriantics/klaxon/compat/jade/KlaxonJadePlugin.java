...
public class KlaxonJadePlugin implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        ...
        registration.registerBlockDataProvider(TurbineGeneratorPartProvider.INSTANCE, TurbineGeneratorBlock.class);
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.registerBlockComponent(TurbineGeneratorPartProvider.INSTANCE, TurbineGeneratorBlock.class);
