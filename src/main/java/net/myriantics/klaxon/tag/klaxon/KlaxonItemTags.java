...
public abstract class KlaxonItemTags {
    ...
    public static final TagKey<Item> OMINOUS_DEEPSLATE_BLAST_PROCESSOR_SUMMONING_ITEMS =
            createTag("ominous_deepslate_blast_processor_summoning_items");
    public static final TagKey<Item> UNUSABLE_FOR_EXPLOSIVE_CATALYST_TRANSMUTATION =
            createTag("unusable_for_explosive_catalyst_transmutation");
