...
public abstract class KlaxonOxidationRegistry {
    ...
    public static void init() {
        ...
        OxidizableBlocksRegistry.registerOxidizableBlockPair(KlaxonBlocks.COPPER_WIRE_SPOOL_BLOCK, KlaxonBlocks.EXPOSED_COPPER_WIRE_SPOOL_BLOCK);
        OxidizableBlocksRegistry.registerOxidizableBlockPair(KlaxonBlocks.EXPOSED_COPPER_WIRE_SPOOL_BLOCK, KlaxonBlocks.WEATHERED_COPPER_WIRE_SPOOL_BLOCK);
        OxidizableBlocksRegistry.registerOxidizableBlockPair(KlaxonBlocks.WEATHERED_COPPER_WIRE_SPOOL_BLOCK, KlaxonBlocks.OXIDIZED_COPPER_WIRE_SPOOL_BLOCK);
        OxidizableBlocksRegistry.registerWaxableBlockPair(KlaxonBlocks.COPPER_WIRE_SPOOL_BLOCK, KlaxonBlocks.WAXED_COPPER_WIRE_SPOOL_BLOCK);
        OxidizableBlocksRegistry.registerWaxableBlockPair(KlaxonBlocks.EXPOSED_COPPER_WIRE_SPOOL_BLOCK, KlaxonBlocks.WAXED_EXPOSED_COPPER_WIRE_SPOOL_BLOCK);
        OxidizableBlocksRegistry.registerWaxableBlockPair(KlaxonBlocks.WEATHERED_COPPER_WIRE_SPOOL_BLOCK, KlaxonBlocks.WAXED_WEATHERED_COPPER_WIRE_SPOOL_BLOCK);
        OxidizableBlocksRegistry.registerWaxableBlockPair(KlaxonBlocks.OXIDIZED_COPPER_WIRE_SPOOL_BLOCK, KlaxonBlocks.WAXED_OXIDIZED_COPPER_WIRE_SPOOL_BLOCK);
