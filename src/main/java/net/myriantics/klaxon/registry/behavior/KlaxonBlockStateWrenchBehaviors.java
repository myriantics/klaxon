...
public abstract class KlaxonBlockStateWrenchBehaviors {
    ...
    public static final BlockStateWrenchBehavior<FrontAndTop> ORIENTATION = register("orientation", OrientationBlockStateWrenchBehavior::new);
    ...
    private static <T extends Comparable<T>> BlockStateWrenchBehavior<T> register(String name, Function<ResourceLocation, BlockStateWrenchBehavior<T>> constructor) {
