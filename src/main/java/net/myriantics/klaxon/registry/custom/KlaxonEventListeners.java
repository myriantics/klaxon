...
public class KlaxonEventListeners {
    public static void init() {
        ...
        ServerLifecycleEvents.SERVER_STARTED.register(InnateItemEnchantmentsComponent::onServerStarted);

        KlaxonCommon.LOGGER.info("Registered KLAXON's Event Listeners!");
    }

    public static void initClient() {
        ClientPlayConnectionEvents.JOIN.register(InnateItemEnchantmentsComponent::onClientFinishJoinWorld);
    }
}
