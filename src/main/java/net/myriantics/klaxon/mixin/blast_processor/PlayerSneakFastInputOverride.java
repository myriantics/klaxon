...
public abstract class PlayerSneakFastInputOverride {
    ...
    public boolean checkForFastInput(
        ...
        if (world.getBlockEntity(hitResult.getBlockPos()) instanceof BlastProcessorBlockEntity blastProcessor) {
            ...
            //player.sendMessage(Text.literal("client: " + world.isClient + (availableSlots == null)));
            player.sendMessage(Text.literal("isSneaking " + true));
