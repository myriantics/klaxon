...
public abstract class FireworkParticleMixin {
    ...
    public void klaxon$muffledBlastProcessorSoundOverride(ClientWorld instance, double x, double y, double z, SoundEvent sound, SoundCategory category, float volume, float pitch, boolean useDistance, Operation<Void> original) {
