...
public abstract class HugeExplosionSeedParticleMixin extends NoRenderParticle {
    protected HugeExplosionSeedParticleMixin(ClientLevel clientWorld, double d, double e, double f) {
